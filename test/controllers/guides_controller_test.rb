...
class GuidesControllerTest < ActionController::TestCase
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post :create, guide: { guide_for: @guide.guide_for, guide_name: @guide.guide_name, info: @guide.info }
    end
  ...
  test "should update guide" do
    patch :update, id: @guide, guide: { guide_for: @guide.guide_for, guide_name: @guide.guide_name, info: @guide.info }
    assert_redirected_to guide_path(assigns(:guide))
  end
